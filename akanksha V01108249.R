...
# Filter the runs scored by MP Stoinis
MP_Stoinis_runs <- runs %>% filter(Striker == "MP Stoinis") %>% pull(runs_scored)
...
# Fit the distribution to MP Stoinis's runs scored and get the best distribution
best_distribution <- get_best_distribution(MP_Stoinis_runs)
